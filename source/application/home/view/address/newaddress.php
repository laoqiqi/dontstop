...
<body>
      <div id="app">
		<div id="wrapper">
			<div class="int_title"><span class="int_pic"><img src="images/jifen/left.png"/></span>新建地址</div>
			<div class="m_pwd">
        ...
        methods:{
            handclick(){
                ...
                this.$http.post("Index.php?s=/home/Address/add/",
                    {params:{name:username,phone:phone,province_id:province_id,city_id:city_id,region_id:region_id,detail:detail}}).
                then(function(res){
                    let _info=  res;
                    if (res.body==1)
                    {
