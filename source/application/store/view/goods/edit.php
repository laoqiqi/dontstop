                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <?php else: ?>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">首页展示</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[newest]" value="10" data-am-ucheck
                                                  >
                                        ...
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[newest]" value="0" data-am-ucheck  checked>
                                            否
                                        </label>
                                    </div>
                                </div>
