                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <?php if ($model['status']==10): ?>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否最新上架</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[newest]" value="10" data-am-ucheck
                                                   checked>
                                            是
                                        </label>
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[newest]" value="20" data-am-ucheck>
                                            否
                                        </label>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[status]" value="10" data-am-ucheck
                                            >
                                            是
                                        </label>
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[status]" value="0" data-am-ucheck  checked>
                                            否
                                        </label>
                                    </div>
                                </div>
