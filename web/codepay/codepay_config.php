 ...
 *
 */
define('DB_USERTABLE', 'yoshop_user');  //充值用户所在数据库表名
define('DB_USERMONEY', 'money');  //充值用户所在表中的金额字段名
define('DB_USERNAME', 'user_id');  //充值用户名的字段名 根据用户名转换为id
